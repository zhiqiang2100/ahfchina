...
<div class="flexslider">
	<ul class="slides">
                    ...
                    foreach ( $lunboList  as $key => $value ) { ?>
		                <li> <img src="<?php echo Be_Config::k('common.static_host').$value['url']?>"></li>
                    <?php } ?>
                    <?php } ?>
	</ul>
</div>
...
<div class="content">
	...
	<div class="proControl">
		<div class="proControlInfo clearfix">
			<div class="project fl">
				<h2>项目列表<em>PROJECT LIST</em></h2>
				<ul>
                    <?php if ( Be_Libs_Tool::be_array($xmList) ) {
                        foreach ( $xmList  as $key => $value ) { ?>
					<li>
                    <a href="#" class="fl"><img src="<?php echo $value['images'][0]?>" width="145" height="97"></a>
	...
	<div class="detecPoint">
		<div class="pointMain clearfix">
			<h2>检 测 点<em>TEST STATION</em></h2>
